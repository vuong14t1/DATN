...
* [#11387](http://dev.ckeditor.com/ticket/11387): Fixed: `name="radiogroup"` should be applied only to radio inputs' container.
...
* [#5217](http://dev.ckeditor.com/ticket/5217): Setting data (including switching between modes) creates a new undo snapshot. Besides that:
  * Introduced the [`editable.action`](http://docs.ckeditor.com/#!/api/CKEDITOR.editable-property-action) property.
...
* [#10360](http://dev.ckeditor.com/ticket/10360): Fixed: ARIA `name="application"` should not be used for dialog windows.
* [#10361](http://dev.ckeditor.com/ticket/10361): Fixed: ARIA `name="application"` should not be used for floating panels.
...
* Included in [#10103](http://dev.ckeditor.com/ticket/10103):
  * Introduced the [`editor.action`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-property-action) property to make it easier to check the current action of the editor.
